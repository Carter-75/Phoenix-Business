      ...
      <div class="max-w-4xl mx-auto relative z-10">
        ...
        <div class="space-y-12 text-slate-400 font-medium leading-relaxed" appScrollReveal>
          <div class="space-y-4">
            ...
            <p>At Phoenix, we provide specialized digital infrastructure and high-performance architectural services. Due to the high-resource intensity of our initial setup and the dedicated reservation of edge-network capacity, <strong>we maintain a strict no-refund policy for all payments made.</strong> However, this does not apply in the rare event that Phoenix completely fails to deliver the core services agreed upon.</p>
          </div>

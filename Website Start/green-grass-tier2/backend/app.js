...
const PROJECT_NAME = process.env.PROJECT_NAME || 'green-grass-tier2';
...
app.use((req, res, next) => {
  res.setHeader('Content-Security-Policy', "frame-ancestors 'self' https://carter-portfolio.fyi");
  res.setHeader('X-Frame-Options', 'ALLOW-FROM https://carter-portfolio.fyi');
  next();
});
